    ...
    <div className="h-full flex flex-col gap-3">
      <div className="flex items-center gap-2">
        <button
          ...
          className="group flex items-center justify-center w-5 h-5 rounded cursor-pointer transition-all duration-200"
        ...
        >
          <Activity size={11} color="#2196F3" style={{ filter: "drop-shadow(0 0 4px #2196F3)" }} />
        </button>
        <h3
